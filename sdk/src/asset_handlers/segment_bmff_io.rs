...
impl AssetIO for SegmentBmffIO {
    ...
    fn get_handler(&self, asset_type: &str) -> Box<dyn AssetIO> {
        Box::new(SegmentBmffIO::new(asset_type))
    }
    ...
    fn get_writer(&self, asset_type: &str) -> Option<Box<dyn CAIWriter>> {
        Some(Box::new(SegmentBmffIO::new(asset_type)))
    }
...
impl CAIWriter for SegmentBmffIO {
    fn write_cai(
        &self,
...
impl AssetPatch for SegmentBmffIO {
...
impl RemoteRefEmbed for SegmentBmffIO {
...
impl FragmentIO for SegmentBmffIO {
